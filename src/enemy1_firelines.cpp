...
Fireline::Fireline(float x, float y, color_t color) {
    ...
    yy = 0.4 + static_cast <float> (rand()) /( static_cast <float> (RAND_MAX/(2.0)));
    // xx = 1.0, yy = 1.0;
     this->scalex = 10000.0;
    this->scaley = 5.0;
    this->scalez = 5.0;
...
void Fireline::tick() {
    ...
    {
         this->position.x = 6.0 + 0.2 + static_cast <float> (rand()) /( static_cast <float> (RAND_MAX/(2.0)));
         this->position.y = 0.4 + static_cast <float> (rand()) /( static_cast <float> (RAND_MAX/(2.0)));
    }
}
